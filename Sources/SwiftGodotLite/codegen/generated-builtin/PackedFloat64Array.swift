...
/// 
public class PackedFloat64Array: Equatable, Collection {
    static var destructor: GDExtensionPtrDestructor = {
        return gi.variant_get_ptr_destructor (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY)!
    }()
    
    deinit {
        if content != PackedFloat64Array.zero {
            PackedFloat64Array.destructor (&content)
        }
    ...
    public required init (content: ContentType) {
        ...
        withUnsafePointer (to: &copy) { ptr in
            args.append (ptr)
            PackedFloat64Array.constructor1 (&self.content, &args)
        }
    ...
    public required init () {
        PackedFloat64Array.constructor0 (&content, nil)
    }
    ...
    public init (from: PackedFloat64Array) {
        ...
        withUnsafePointer (to: &from.content) { p0 in
            ...
            PackedFloat64Array.constructor1 (&content, &args)
        }
    }
    ...
    /// Constructs a new ``PackedFloat64Array``. Optionally, you can pass in a generic ``GArray`` that will be converted.
    public init (from: GArray) {
        var args: [UnsafeRawPointer?] = []
        withUnsafePointer (to: &from.content) { p0 in
            args.append (p0)
        
            PackedFloat64Array.constructor2 (&content, &args)
        }
    }
    ...
    static var method_size: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 3173160232)!
    }()
    
    /// Returns the number of elements in the array.
    public final func size ()-> Int64 {
        var result: Int64 = Int64()
        PackedFloat64Array.method_size (&content, nil, &result, 0)
        return result
    }
    
    static var method_is_empty: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("is_empty")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 3918633141)!
    }()
    
    /// Returns `true` if the array is empty.
    public final func isEmpty ()-> Bool {
        var result: Bool = Bool()
        PackedFloat64Array.method_is_empty (&content, nil, &result, 0)
        return result
    }
    
    static var method_set: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("set")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 1113000516)!
    }()
    ...
    public final func set (index: Int64, value: Double) {
        ...
        withUnsafePointer (to: &copy_index) { p0 in
            ...
            withUnsafePointer (to: &copy_value) { p1 in
                ...
                PackedFloat64Array.method_set (&content, &args, nil, 2)
            }
        }
    }
    ...
    static var method_push_back: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 4094791666)!
    }()
    ...
    public final func pushBack (value: Double)-> Bool {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedFloat64Array.method_push_back (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func append (value: Double)-> Bool {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedFloat64Array.method_append (&content, &args, &result, 1)
            return result
        }
    }
    ...
    static var method_append_array: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 792078629)!
    }()
    
    /// Appends a ``PackedFloat64Array`` at the end of this array.
    public final func appendArray (_ array: PackedFloat64Array) {
        var args: [UnsafeRawPointer?] = []
        withUnsafePointer (to: &array.content) { p0 in
            args.append (p0)
        
            PackedFloat64Array.method_append_array (&content, &args, nil, 1)
        }
    }
    
    static var method_remove_at: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("remove_at")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 2823966027)!
    }()
    ...
    public final func removeAt (index: Int64) {
        ...
        withUnsafePointer (to: &copy_index) { p0 in
            ...
            PackedFloat64Array.method_remove_at (&content, &args, nil, 1)
        }
    }
    
    static var method_insert: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("insert")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 1379903876)!
    }()
    ...
    public final func insert (atIndex: Int64, value: Double)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_at_index) { p0 in
            ...
            return withUnsafePointer (to: &copy_value) { p1 in
                ...
                PackedFloat64Array.method_insert (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    static var method_fill: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 833936903)!
    }()
    ...
    public final func fill (value: Double) {
        ...
        withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedFloat64Array.method_fill (&content, &args, nil, 1)
        }
    }
    
    static var method_resize: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("resize")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 848867239)!
    }()
    ...
    public final func resize (newSize: Int64)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_new_size) { p0 in
            ...
            PackedFloat64Array.method_resize (&content, &args, &result, 1)
            return result
        }
    }
    ...
    static var method_clear: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 3218959716)!
    }()
    
    /// Clears the array. This is equivalent to using ``resize(newSize:)`` with a size of `0`.
    public final func clear () {
        PackedFloat64Array.method_clear (&content, nil, nil, 0)
    }
    
    static var method_has: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("has")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 1296369134)!
    }()
    ...
    public final func has (value: Double)-> Bool {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedFloat64Array.method_has (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func reverse () {
        PackedFloat64Array.method_reverse (&content, nil, nil, 0)
    }
    
    static var method_slice: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("slice")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 2192974324)!
    }()
    ...
    /// 
    public final func slice (begin: Int64, end: Int64 = 2147483647)-> PackedFloat64Array {
        ...
        return withUnsafePointer (to: &copy_begin) { p0 in
            ...
            return withUnsafePointer (to: &copy_end) { p1 in
                ...
                PackedFloat64Array.method_slice (&content, &args, &result.content, 2)
                return result
            }
        }
    }
    ...
    static var method_to_byte_array: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 247621236)!
    }()
    ...
    public final func toByteArray ()-> PackedByteArray {
        ...
        PackedFloat64Array.method_to_byte_array (&content, nil, &result.content, 0)
        return result
    }
    ...
    public final func sort () {
        PackedFloat64Array.method_sort (&content, nil, nil, 0)
    }
    
    static var method_bsearch: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("bsearch")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 1188816338)!
    }()
    ...
    public final func bsearch (value: Double, before: Bool = true)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            return withUnsafePointer (to: &copy_before) { p1 in
                ...
                PackedFloat64Array.method_bsearch (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    static var method_duplicate: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 949266573)!
    }()
    
    /// Creates a copy of the array, and returns it.
    public final func duplicate ()-> PackedFloat64Array {
        let result: PackedFloat64Array = PackedFloat64Array()
        PackedFloat64Array.method_duplicate (&content, nil, &result.content, 0)
        return result
    }
    
    static var method_find: GDExtensionPtrBuiltInMethod = {
        let name = StringName ("find")
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 1343150241)!
    }()
    ...
    public final func find (value: Double, from: Int64 = 0)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            return withUnsafePointer (to: &copy_from) { p1 in
                ...
                PackedFloat64Array.method_find (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func rfind (value: Double, from: Int64 = -1)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            return withUnsafePointer (to: &copy_from) { p1 in
                ...
                PackedFloat64Array.method_rfind (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    static var method_count: GDExtensionPtrBuiltInMethod = {
        ...
        return gi.variant_get_ptr_builtin_method (GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, &name.content, 2859915090)!
    }()
    ...
    public final func count (value: Double)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedFloat64Array.method_count (&content, &args, &result, 1)
            return result
        }
    }
    
    static var operator_5: GDExtensionPtrOperatorEvaluator = {
        return gi.variant_get_ptr_operator_evaluator (GDEXTENSION_VARIANT_OP_EQUAL, GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY)!
    }()
    ...
    public static func == (lhs: PackedFloat64Array, rhs: PackedFloat64Array) -> Bool  {
        ...
        PackedFloat64Array.operator_5 (&lhs.content, &rhs.content, &result)
        return result
    }
    
    static var operator_6: GDExtensionPtrOperatorEvaluator = {
        return gi.variant_get_ptr_operator_evaluator (GDEXTENSION_VARIANT_OP_NOT_EQUAL, GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY)!
    }()
    ...
    public static func != (lhs: PackedFloat64Array, rhs: PackedFloat64Array) -> Bool  {
        ...
        PackedFloat64Array.operator_6 (&lhs.content, &rhs.content, &result)
        return result
    }
    
    static var operator_7: GDExtensionPtrOperatorEvaluator = {
        return gi.variant_get_ptr_operator_evaluator (GDEXTENSION_VARIANT_OP_ADD, GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY, GDEXTENSION_VARIANT_TYPE_PACKED_FLOAT64_ARRAY)!
    }()
    
    /// Returns a new ``PackedFloat64Array`` with contents of `right` added at the end of this array. For better performance, consider using ``appendArray(array:)`` instead.
    public static func + (lhs: PackedFloat64Array, rhs: PackedFloat64Array) -> PackedFloat64Array  {
        let result: PackedFloat64Array = PackedFloat64Array()
        
        PackedFloat64Array.operator_7 (&lhs.content, &rhs.content, &result.content)
        return result
    }
