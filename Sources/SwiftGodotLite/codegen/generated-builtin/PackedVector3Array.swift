...
public class PackedVector3Array: Equatable, Collection {
    ...
    public required init (content: ContentType) {
        ...
        withUnsafePointer (to: &copy) { ptr in
            args.append (ptr)
            PackedVector3Array.constructor1 (&self.content, &args)
        }
    ...
    public init (from: PackedVector3Array) {
        ...
        withUnsafePointer (to: &from.content) { p0 in
            ...
            PackedVector3Array.constructor1 (&content, &args)
        }
    }
    ...
    public init (from: GArray) {
        ...
        withUnsafePointer (to: &from.content) { p0 in
            ...
            PackedVector3Array.constructor2 (&content, &args)
        }
    }
    ...
    public final func set (index: Int64, value: Vector3) {
        ...
        withUnsafePointer (to: &copy_index) { p0 in
            ...
            withUnsafePointer (to: &copy_value) { p1 in
                ...
                PackedVector3Array.method_set (&content, &args, nil, 2)
            }
        }
    }
    ...
    public final func pushBack (value: Vector3)-> Bool {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedVector3Array.method_push_back (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func append (value: Vector3)-> Bool {
        var result: Bool = Bool()
        var copy_value = value
        var args: [UnsafeRawPointer?] = []
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedVector3Array.method_append (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func appendArray (_ array: PackedVector3Array) {
        ...
        withUnsafePointer (to: &array.content) { p0 in
            ...
            PackedVector3Array.method_append_array (&content, &args, nil, 1)
        }
    }
    ...
    public final func removeAt (index: Int64) {
        ...
        withUnsafePointer (to: &copy_index) { p0 in
            ...
            PackedVector3Array.method_remove_at (&content, &args, nil, 1)
        }
    }
    ...
    public final func insert (atIndex: Int64, value: Vector3)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_at_index) { p0 in
            ...
            return withUnsafePointer (to: &copy_value) { p1 in
                ...
                PackedVector3Array.method_insert (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func fill (value: Vector3) {
        ...
        withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedVector3Array.method_fill (&content, &args, nil, 1)
        }
    }
    ...
    public final func resize (newSize: Int64)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_new_size) { p0 in
            ...
            PackedVector3Array.method_resize (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func has (value: Vector3)-> Bool {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedVector3Array.method_has (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func slice (begin: Int64, end: Int64 = 2147483647)-> PackedVector3Array {
        ...
        return withUnsafePointer (to: &copy_begin) { p0 in
            ...
            return withUnsafePointer (to: &copy_end) { p1 in
                ...
                PackedVector3Array.method_slice (&content, &args, &result.content, 2)
                return result
            }
        }
    }
    ...
    public final func bsearch (value: Vector3, before: Bool = true)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            return withUnsafePointer (to: &copy_before) { p1 in
                ...
                PackedVector3Array.method_bsearch (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func find (value: Vector3, from: Int64 = 0)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            return withUnsafePointer (to: &copy_from) { p1 in
                ...
                PackedVector3Array.method_find (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func rfind (value: Vector3, from: Int64 = -1)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            return withUnsafePointer (to: &copy_from) { p1 in
                ...
                PackedVector3Array.method_rfind (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func count (value: Vector3)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_value) { p0 in
            ...
            PackedVector3Array.method_count (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public static func * (lhs: PackedVector3Array, rhs: Transform3D) -> PackedVector3Array  {
        ...
        PackedVector3Array.operator_3 (&lhs.content, &copy_rhs, &result.content)
        return result
    }
    ...
    public static func == (lhs: PackedVector3Array, rhs: PackedVector3Array) -> Bool  {
        ...
        PackedVector3Array.operator_6 (&lhs.content, &rhs.content, &result)
        return result
    }
    ...
    public static func != (lhs: PackedVector3Array, rhs: PackedVector3Array) -> Bool  {
        ...
        PackedVector3Array.operator_7 (&lhs.content, &rhs.content, &result)
        return result
    }
    ...
    public static func + (lhs: PackedVector3Array, rhs: PackedVector3Array) -> PackedVector3Array  {
        ...
        PackedVector3Array.operator_8 (&lhs.content, &rhs.content, &result.content)
        return result
    }
