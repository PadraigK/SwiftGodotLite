...
public struct Rect2i: Equatable, Hashable {
    ...
    public func getCenter ()-> Vector2i {
        ...
        withUnsafePointer (to: self) { ptr in 
            Rect2i.method_get_center (UnsafeMutableRawPointer (mutating: ptr), nil, &result, 0)
        }
        return result
    }
    ...
    public func getArea ()-> Int64 {
        ...
        withUnsafePointer (to: self) { ptr in 
            Rect2i.method_get_area (UnsafeMutableRawPointer (mutating: ptr), nil, &result, 0)
        }
        return result
    }
    ...
    public func hasArea ()-> Bool {
        ...
        withUnsafePointer (to: self) { ptr in 
            Rect2i.method_has_area (UnsafeMutableRawPointer (mutating: ptr), nil, &result, 0)
        }
        return result
    }
    ...
    public func hasPoint (_ point: Vector2i)-> Bool {
        ...
        return withUnsafePointer (to: &copy_point) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_has_point (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func intersects (b: Rect2i)-> Bool {
        ...
        return withUnsafePointer (to: &copy_b) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_intersects (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func encloses (b: Rect2i)-> Bool {
        ...
        return withUnsafePointer (to: &copy_b) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_encloses (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func intersection (b: Rect2i)-> Rect2i {
        ...
        return withUnsafePointer (to: &copy_b) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_intersection (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func merge (b: Rect2i)-> Rect2i {
        ...
        return withUnsafePointer (to: &copy_b) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_merge (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func expand (to: Vector2i)-> Rect2i {
        ...
        return withUnsafePointer (to: &copy_to) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_expand (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func grow (amount: Int64)-> Rect2i {
        ...
        return withUnsafePointer (to: &copy_amount) { p0 in
            ...
            withUnsafePointer (to: self) { ptr in 
                Rect2i.method_grow (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 1)
            }
            return result
        }
    }
    ...
    public func growSide (_ side: Int64, amount: Int64)-> Rect2i {
        ...
        return withUnsafePointer (to: &copy_side) { p0 in
            ...
            return withUnsafePointer (to: &copy_amount) { p1 in
                ...
                withUnsafePointer (to: self) { ptr in 
                    Rect2i.method_grow_side (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 2)
                }
                return result
            }
        }
            ...
            return withUnsafePointer (to: &copy_top) { p1 in
                ...
                return withUnsafePointer (to: &copy_right) { p2 in
                    ...
                    return withUnsafePointer (to: &copy_bottom) { p3 in
                        ...
                        withUnsafePointer (to: self) { ptr in 
                            Rect2i.method_grow_individual (UnsafeMutableRawPointer (mutating: ptr), &args, &result, 4)
                        }
                        return result
                    }
                }
    ...
    public func abs ()-> Rect2i {
        var result: Rect2i = Rect2i()
        withUnsafePointer (to: self) { ptr in 
            Rect2i.method_abs (UnsafeMutableRawPointer (mutating: ptr), nil, &result, 0)
        }
        return result
    }
    ...
    public static func == (lhs: Rect2i, rhs: Rect2i) -> Bool  {
        ...
        Rect2i.operator_3 (&copy_lhs, &copy_rhs, &result)
        return result
    }
    ...
    public static func != (lhs: Rect2i, rhs: Rect2i) -> Bool  {
        ...
        Rect2i.operator_4 (&copy_lhs, &copy_rhs, &result)
        return result
    }
