...
/// 
/// If you want to join the strings in the array, use ``String/join(parts:)``.
/// 
public class PackedStringArray: Equatable, Collection {
    ...
    public required init (content: ContentType) {
        ...
        withUnsafePointer (to: &copy) { ptr in
            args.append (ptr)
            PackedStringArray.constructor1 (&self.content, &args)
        }
    ...
    public init (from: PackedStringArray) {
        ...
        withUnsafePointer (to: &from.content) { p0 in
            ...
            PackedStringArray.constructor1 (&content, &args)
        }
    }
    ...
    public init (from: GArray) {
        ...
        withUnsafePointer (to: &from.content) { p0 in
            ...
            PackedStringArray.constructor2 (&content, &args)
        }
    }
    ...
    public final func set (index: Int64, value: String) {
        ...
        withUnsafePointer (to: &copy_index) { p0 in
            ...
            withUnsafePointer (to: &gstr_value.content) { p1 in
                ...
                PackedStringArray.method_set (&content, &args, nil, 2)
            }
        }
    }
    ...
    public final func pushBack (value: String)-> Bool {
        ...
        let gstr_value = GString (value)
        var args: [UnsafeRawPointer?] = []
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            args.append (p0)
        
            PackedStringArray.method_push_back (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func append (value: String)-> Bool {
        var result: Bool = Bool()
        let gstr_value = GString (value)
        var args: [UnsafeRawPointer?] = []
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            PackedStringArray.method_append (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func appendArray (_ array: PackedStringArray) {
        ...
        withUnsafePointer (to: &array.content) { p0 in
            ...
            PackedStringArray.method_append_array (&content, &args, nil, 1)
        }
    }
    ...
    public final func removeAt (index: Int64) {
        ...
        withUnsafePointer (to: &copy_index) { p0 in
            ...
            PackedStringArray.method_remove_at (&content, &args, nil, 1)
        }
    }
    ...
    public final func insert (atIndex: Int64, value: String)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_at_index) { p0 in
            args.append (p0)
            return withUnsafePointer (to: &gstr_value.content) { p1 in
                args.append (p1)
        
                PackedStringArray.method_insert (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func fill (value: String) {
        ...
        withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            PackedStringArray.method_fill (&content, &args, nil, 1)
        }
    }
    ...
    public final func resize (newSize: Int64)-> Int64 {
        ...
        return withUnsafePointer (to: &copy_new_size) { p0 in
            ...
            PackedStringArray.method_resize (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func has (value: String)-> Bool {
        ...
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            PackedStringArray.method_has (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public final func slice (begin: Int64, end: Int64 = 2147483647)-> PackedStringArray {
        ...
        return withUnsafePointer (to: &copy_begin) { p0 in
            ...
            return withUnsafePointer (to: &copy_end) { p1 in
                ...
                PackedStringArray.method_slice (&content, &args, &result.content, 2)
                return result
            }
        }
    }
    ...
    public final func bsearch (value: String, before: Bool = true)-> Int64 {
        ...
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            return withUnsafePointer (to: &copy_before) { p1 in
                ...
                PackedStringArray.method_bsearch (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func find (value: String, from: Int64 = 0)-> Int64 {
        ...
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            return withUnsafePointer (to: &copy_from) { p1 in
                ...
                PackedStringArray.method_find (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func rfind (value: String, from: Int64 = -1)-> Int64 {
        ...
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            return withUnsafePointer (to: &copy_from) { p1 in
                ...
                PackedStringArray.method_rfind (&content, &args, &result, 2)
                return result
            }
        }
    }
    ...
    public final func count (value: String)-> Int64 {
        ...
        return withUnsafePointer (to: &gstr_value.content) { p0 in
            ...
            PackedStringArray.method_count (&content, &args, &result, 1)
            return result
        }
    }
    ...
    public static func == (lhs: PackedStringArray, rhs: PackedStringArray) -> Bool  {
        ...
        PackedStringArray.operator_5 (&lhs.content, &rhs.content, &result)
        return result
    }
    ...
    public static func != (lhs: PackedStringArray, rhs: PackedStringArray) -> Bool  {
        ...
        PackedStringArray.operator_6 (&lhs.content, &rhs.content, &result)
        return result
    }
    ...
    public static func + (lhs: PackedStringArray, rhs: PackedStringArray) -> PackedStringArray  {
        ...
        PackedStringArray.operator_7 (&lhs.content, &rhs.content, &result.content)
        return result
    }
