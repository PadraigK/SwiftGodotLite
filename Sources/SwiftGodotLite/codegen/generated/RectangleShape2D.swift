...
open class RectangleShape2D: Shape2D {
    ...
    fileprivate final func set_size (_ size: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (RectangleShape2D.method_set_size, UnsafeMutableRawPointer (mutating: handle), nil, &copy_size)
        ...
        withUnsafePointer (to: &copy_size) { p0 in
            ...
            gi.object_method_bind_ptrcall (RectangleShape2D.method_set_size, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
