...
open class VisualShaderNodeVec4Constant: VisualShaderNodeConstant {
    ...
    fileprivate final func set_constant (_ constant: Quaternion) {
        ...
        gi.object_method_bind_ptrcall_v (VisualShaderNodeVec4Constant.method_set_constant, UnsafeMutableRawPointer (mutating: handle), nil, &copy_constant)
        ...
        withUnsafePointer (to: &copy_constant) { p0 in
            ...
            gi.object_method_bind_ptrcall (VisualShaderNodeVec4Constant.method_set_constant, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
