...
/// Provides parameters for ``PhysicsServer3D/bodyTestMotion(body:parameters:result:)``.
/// 
...
open class PhysicsTestMotionParameters3D: RefCounted {
    override open class var godotClassName: StringName { "PhysicsTestMotionParameters3D" }
    ...
    final public var from: Transform3D {
        get {
            return get_from ()
        }
    ...
    final public var maxCollisions: Int32 {
        get {
            return get_max_collisions ()
        }
        
        set {
            set_max_collisions (newValue)
        }
    ...
    /// 
    /// If set to `false`, shapes of type ``PhysicsServer3D/ShapeType/shapeSeparationRay`` are only used for separation when overlapping with other bodies. That's the main use for separation ray shapes.
    /// 
    ...
    fileprivate final func set_from (_ from: Transform3D) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsTestMotionParameters3D.method_set_from, UnsafeMutableRawPointer (mutating: handle), nil, &copy_from)
        ...
        withUnsafePointer (to: &copy_from) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_from, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_motion (_ motion: Vector3) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsTestMotionParameters3D.method_set_motion, UnsafeMutableRawPointer (mutating: handle), nil, &copy_motion)
        ...
        withUnsafePointer (to: &copy_motion) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_motion, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_margin (_ margin: Double) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsTestMotionParameters3D.method_set_margin, UnsafeMutableRawPointer (mutating: handle), nil, &copy_margin)
        ...
        withUnsafePointer (to: &copy_margin) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_margin, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_max_collisions (_ maxCollisions: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsTestMotionParameters3D.method_set_max_collisions, UnsafeMutableRawPointer (mutating: handle), nil, &copy_max_collisions)
        
        #else
        
        var copy_max_collisions: Int = Int (maxCollisions)
        var _args: [UnsafeRawPointer?] = []
        withUnsafePointer (to: &copy_max_collisions) { p0 in
            _args.append (p0)
        
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_max_collisions, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_collide_separation_ray_enabled (_ enabled: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsTestMotionParameters3D.method_set_collide_separation_ray_enabled, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enabled)
        ...
        withUnsafePointer (to: &copy_enabled) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_collide_separation_ray_enabled, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_exclude_bodies (_ excludeList: VariantCollection<RID>) {
        ...
        withUnsafePointer (to: &excludeList.array.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_exclude_bodies, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_exclude_objects (_ excludeList: VariantCollection<Int64>) {
        ...
        withUnsafePointer (to: &excludeList.array.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_exclude_objects, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_recovery_as_collision_enabled (_ enabled: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsTestMotionParameters3D.method_set_recovery_as_collision_enabled, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enabled)
        ...
        withUnsafePointer (to: &copy_enabled) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsTestMotionParameters3D.method_set_recovery_as_collision_enabled, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
