...
open class VisualShaderNodeColorParameter: VisualShaderNodeParameter {
    override open class var godotClassName: StringName { "VisualShaderNodeColorParameter" }
    ...
    fileprivate final func set_default_value_enabled (_ enabled: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (VisualShaderNodeColorParameter.method_set_default_value_enabled, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enabled)
        ...
        withUnsafePointer (to: &copy_enabled) { p0 in
            ...
            gi.object_method_bind_ptrcall (VisualShaderNodeColorParameter.method_set_default_value_enabled, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_default_value (_ value: Color) {
        ...
        gi.object_method_bind_ptrcall_v (VisualShaderNodeColorParameter.method_set_default_value, UnsafeMutableRawPointer (mutating: handle), nil, &copy_value)
        ...
        withUnsafePointer (to: &copy_value) { p0 in
            ...
            gi.object_method_bind_ptrcall (VisualShaderNodeColorParameter.method_set_default_value, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
