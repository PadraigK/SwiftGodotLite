...
open class CapsuleShape2D: Shape2D {
    override open class var godotClassName: StringName { "CapsuleShape2D" }
    ...
    fileprivate static var method_set_radius: GDExtensionMethodBindPtr = {
        ...
        return withUnsafePointer (to: &CapsuleShape2D.godotClassName.content) { classPtr in
    ...
    fileprivate final func set_radius (_ radius: Double) {
        ...
        gi.object_method_bind_ptrcall_v (CapsuleShape2D.method_set_radius, UnsafeMutableRawPointer (mutating: handle), nil, &copy_radius)
        ...
        withUnsafePointer (to: &copy_radius) { p0 in
            ...
            gi.object_method_bind_ptrcall (CapsuleShape2D.method_set_radius, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_radius ()-> Double {
        ...
        gi.object_method_bind_ptrcall (CapsuleShape2D.method_get_radius, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_height (_ height: Double) {
        ...
        gi.object_method_bind_ptrcall_v (CapsuleShape2D.method_set_height, UnsafeMutableRawPointer (mutating: handle), nil, &copy_height)
        ...
        withUnsafePointer (to: &copy_height) { p0 in
            ...
            gi.object_method_bind_ptrcall (CapsuleShape2D.method_set_height, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_height ()-> Double {
        var _result: Double = 0.0
        gi.object_method_bind_ptrcall (CapsuleShape2D.method_get_height, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
