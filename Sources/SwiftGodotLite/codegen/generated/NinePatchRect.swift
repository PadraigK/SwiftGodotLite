...
open class NinePatchRect: Control {
    ...
    fileprivate final func set_texture (_ texture: Texture2D?) {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_set_texture, UnsafeMutableRawPointer (mutating: handle), nil, &copy_texture_handle)
        ...
        _args.append (texture == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (NinePatchRect.method_set_texture, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_patch_margin (_ margin: Side, _ value: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_set_patch_margin, UnsafeMutableRawPointer (mutating: handle), nil, &copy_margin, &copy_value)
        ...
        withUnsafePointer (to: &copy_margin) { p0 in
            ...
            withUnsafePointer (to: &copy_value) { p1 in
                ...
                gi.object_method_bind_ptrcall (NinePatchRect.method_set_patch_margin, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    fileprivate final func get_patch_margin (_ margin: Side)-> Int32 {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_get_patch_margin, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_margin)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_margin) { p0 in
            ...
            gi.object_method_bind_ptrcall (NinePatchRect.method_get_patch_margin, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    fileprivate final func set_region_rect (_ rect: Rect2) {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_set_region_rect, UnsafeMutableRawPointer (mutating: handle), nil, &copy_rect)
        ...
        withUnsafePointer (to: &copy_rect) { p0 in
            ...
            gi.object_method_bind_ptrcall (NinePatchRect.method_set_region_rect, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_draw_center (_ drawCenter: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_set_draw_center, UnsafeMutableRawPointer (mutating: handle), nil, &copy_draw_center)
        ...
        withUnsafePointer (to: &copy_draw_center) { p0 in
            ...
            gi.object_method_bind_ptrcall (NinePatchRect.method_set_draw_center, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_h_axis_stretch_mode (_ mode: NinePatchRect.AxisStretchMode) {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_set_h_axis_stretch_mode, UnsafeMutableRawPointer (mutating: handle), nil, &copy_mode)
        ...
        withUnsafePointer (to: &copy_mode) { p0 in
            ...
            gi.object_method_bind_ptrcall (NinePatchRect.method_set_h_axis_stretch_mode, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_v_axis_stretch_mode (_ mode: NinePatchRect.AxisStretchMode) {
        ...
        gi.object_method_bind_ptrcall_v (NinePatchRect.method_set_v_axis_stretch_mode, UnsafeMutableRawPointer (mutating: handle), nil, &copy_mode)
        ...
        withUnsafePointer (to: &copy_mode) { p0 in
            ...
            gi.object_method_bind_ptrcall (NinePatchRect.method_set_v_axis_stretch_mode, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
