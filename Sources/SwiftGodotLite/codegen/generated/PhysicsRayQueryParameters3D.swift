...
open class PhysicsRayQueryParameters3D: RefCounted {
    ...
    public static func create (from: Vector3, to: Vector3, collisionMask: UInt32 = 4294967295, exclude: VariantCollection<RID> = VariantCollection<RID> ())-> PhysicsRayQueryParameters3D? {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_create, nil, &_result, &copy_from, &copy_to, &copy_collision_mask, &exclude.array.content)
            ...
            return withUnsafePointer (to: &copy_to) { p1 in
                ...
                return withUnsafePointer (to: &copy_collision_mask) { p2 in
                    ...
                    return withUnsafePointer (to: &exclude.array.content) { p3 in
                        ...
                        gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_create, nil, &_args, &_result)
                        guard let _result else { return nil } ; return lookupObject (nativeHandle: _result)!
                    }
                }
            }
    ...
    fileprivate final func set_from (_ from: Vector3) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_from, UnsafeMutableRawPointer (mutating: handle), nil, &copy_from)
        ...
        withUnsafePointer (to: &copy_from) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_from, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_to (_ to: Vector3) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_to, UnsafeMutableRawPointer (mutating: handle), nil, &copy_to)
        ...
        withUnsafePointer (to: &copy_to) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_to, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_collision_mask (_ collisionMask: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_collision_mask, UnsafeMutableRawPointer (mutating: handle), nil, &copy_collision_mask)
        ...
        withUnsafePointer (to: &copy_collision_mask) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_collision_mask, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_exclude (_ exclude: VariantCollection<RID>) {
        ...
        withUnsafePointer (to: &exclude.array.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_exclude, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_collide_with_bodies (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_collide_with_bodies, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_collide_with_bodies, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_collide_with_areas (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_collide_with_areas, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_collide_with_areas, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_hit_from_inside (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_hit_from_inside, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_hit_from_inside, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_hit_back_faces (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsRayQueryParameters3D.method_set_hit_back_faces, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (PhysicsRayQueryParameters3D.method_set_hit_back_faces, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
