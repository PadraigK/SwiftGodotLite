...
open class VisualShaderNodeBooleanConstant: VisualShaderNodeConstant {
    ...
    fileprivate final func set_constant (_ constant: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (VisualShaderNodeBooleanConstant.method_set_constant, UnsafeMutableRawPointer (mutating: handle), nil, &copy_constant)
        ...
        withUnsafePointer (to: &copy_constant) { p0 in
            ...
            gi.object_method_bind_ptrcall (VisualShaderNodeBooleanConstant.method_set_constant, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
