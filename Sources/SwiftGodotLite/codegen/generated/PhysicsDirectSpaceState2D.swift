...
open class PhysicsDirectSpaceState2D: Object {
    ...
    public final func intersectPoint (parameters: PhysicsPointQueryParameters2D?, maxResults: Int32 = 32)-> VariantCollection<GDictionary> {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsDirectSpaceState2D.method_intersect_point, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_parameters_handle, &copy_max_results)
        ...
        _args.append (parameters == nil ? nil : p0)
            return withUnsafePointer (to: &copy_max_results) { p1 in
                ...
                gi.object_method_bind_ptrcall (PhysicsDirectSpaceState2D.method_intersect_point, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
                return VariantCollection<GDictionary>(content: _result)
            }
        }
    ...
    public final func intersectRay (parameters: PhysicsRayQueryParameters2D?)-> GDictionary {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsDirectSpaceState2D.method_intersect_ray, UnsafeMutableRawPointer (mutating: handle), &_result.content, &copy_parameters_handle)
        return _result
        #else
        ...
        _args.append (parameters == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (PhysicsDirectSpaceState2D.method_intersect_ray, UnsafeMutableRawPointer (mutating: handle), &_args, &_result.content)
            return _result
        }
    ...
    public final func intersectShape (parameters: PhysicsShapeQueryParameters2D?, maxResults: Int32 = 32)-> VariantCollection<GDictionary> {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsDirectSpaceState2D.method_intersect_shape, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_parameters_handle, &copy_max_results)
        return VariantCollection<GDictionary>(content: _result)
        #else
        ...
        _args.append (parameters == nil ? nil : p0)
            return withUnsafePointer (to: &copy_max_results) { p1 in
                ...
                gi.object_method_bind_ptrcall (PhysicsDirectSpaceState2D.method_intersect_shape, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
                return VariantCollection<GDictionary>(content: _result)
            }
        }
    ...
    public final func castMotion (parameters: PhysicsShapeQueryParameters2D?)-> PackedFloat32Array {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsDirectSpaceState2D.method_cast_motion, UnsafeMutableRawPointer (mutating: handle), &_result.content, &copy_parameters_handle)
        return _result
        #else
        ...
        _args.append (parameters == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (PhysicsDirectSpaceState2D.method_cast_motion, UnsafeMutableRawPointer (mutating: handle), &_args, &_result.content)
            return _result
        }
    ...
    public final func collideShape (parameters: PhysicsShapeQueryParameters2D?, maxResults: Int32 = 32)-> VariantCollection<Vector2> {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsDirectSpaceState2D.method_collide_shape, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_parameters_handle, &copy_max_results)
        ...
        _args.append (parameters == nil ? nil : p0)
            return withUnsafePointer (to: &copy_max_results) { p1 in
                ...
                gi.object_method_bind_ptrcall (PhysicsDirectSpaceState2D.method_collide_shape, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
                return VariantCollection<Vector2>(content: _result)
            }
        }
    ...
    public final func getRestInfo (parameters: PhysicsShapeQueryParameters2D?)-> GDictionary {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsDirectSpaceState2D.method_get_rest_info, UnsafeMutableRawPointer (mutating: handle), &_result.content, &copy_parameters_handle)
        return _result
        #else
        ...
        _args.append (parameters == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (PhysicsDirectSpaceState2D.method_get_rest_info, UnsafeMutableRawPointer (mutating: handle), &_args, &_result.content)
            return _result
        }
