...
open class PlaceholderTextureLayered: TextureLayered {
    ...
    fileprivate final func set_size (_ size: Vector2i) {
        ...
        gi.object_method_bind_ptrcall_v (PlaceholderTextureLayered.method_set_size, UnsafeMutableRawPointer (mutating: handle), nil, &copy_size)
        ...
        withUnsafePointer (to: &copy_size) { p0 in
            ...
            gi.object_method_bind_ptrcall (PlaceholderTextureLayered.method_set_size, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_layers (_ layers: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (PlaceholderTextureLayered.method_set_layers, UnsafeMutableRawPointer (mutating: handle), nil, &copy_layers)
        ...
        withUnsafePointer (to: &copy_layers) { p0 in
            ...
            gi.object_method_bind_ptrcall (PlaceholderTextureLayered.method_set_layers, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
