...
open class AnimationLibrary: Resource {
    ...
    public final func addAnimation (name: StringName, animation: Animation?)-> GodotError {
        ...
        gi.object_method_bind_ptrcall_v (AnimationLibrary.method_add_animation, UnsafeMutableRawPointer (mutating: handle), &_result, &name.content, &copy_animation_handle)
        ...
        return withUnsafePointer (to: &name.content) { p0 in
            _args.append (p0)
            return withUnsafePointer (to: animation?.handle) { p1 in
            _args.append (animation == nil ? nil : p1)
        
                gi.object_method_bind_ptrcall (AnimationLibrary.method_add_animation, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
                return GodotError (rawValue: _result)!
            }
        }
    ...
    public final func removeAnimation (name: StringName) {
        ...
        withUnsafePointer (to: &name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimationLibrary.method_remove_animation, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func renameAnimation (name: StringName, newname: StringName) {
        ...
        withUnsafePointer (to: &name.content) { p0 in
            ...
            withUnsafePointer (to: &newname.content) { p1 in
                ...
                gi.object_method_bind_ptrcall (AnimationLibrary.method_rename_animation, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    public final func hasAnimation (name: StringName)-> Bool {
        ...
        return withUnsafePointer (to: &name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimationLibrary.method_has_animation, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    public final func getAnimation (name: StringName)-> Animation? {
        ...
        return withUnsafePointer (to: &name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimationLibrary.method_get_animation, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            guard let _result else { return nil } ; return lookupObject (nativeHandle: _result)!
        }
