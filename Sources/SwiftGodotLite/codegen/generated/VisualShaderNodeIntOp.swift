...
open class VisualShaderNodeIntOp: VisualShaderNode {
    ...
    fileprivate final func set_operator (_ op: VisualShaderNodeIntOp.Operator) {
        ...
        gi.object_method_bind_ptrcall_v (VisualShaderNodeIntOp.method_set_operator, UnsafeMutableRawPointer (mutating: handle), nil, &copy_op)
        ...
        withUnsafePointer (to: &copy_op) { p0 in
            ...
            gi.object_method_bind_ptrcall (VisualShaderNodeIntOp.method_set_operator, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
