...
open class PhysicsServer2DManager: Object {
    ...
    public static func registerServer (name: String, createCallback: Callable) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsServer2DManager.method_register_server, UnsafeMutableRawPointer (mutating: shared.handle), nil, &gstr_name.content, &createCallback.content)
        ...
        withUnsafePointer (to: &gstr_name.content) { p0 in
            ...
            withUnsafePointer (to: &createCallback.content) { p1 in
                ...
                gi.object_method_bind_ptrcall (PhysicsServer2DManager.method_register_server, UnsafeMutableRawPointer (mutating: shared.handle), &_args, nil)
            }
        }
    ...
    public static func setDefaultServer (name: String, priority: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (PhysicsServer2DManager.method_set_default_server, UnsafeMutableRawPointer (mutating: shared.handle), nil, &gstr_name.content, &copy_priority)
        ...
        withUnsafePointer (to: &gstr_name.content) { p0 in
            ...
            withUnsafePointer (to: &copy_priority) { p1 in
                ...
                gi.object_method_bind_ptrcall (PhysicsServer2DManager.method_set_default_server, UnsafeMutableRawPointer (mutating: shared.handle), &_args, nil)
            }
        }
