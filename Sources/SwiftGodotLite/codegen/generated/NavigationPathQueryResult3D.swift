...
open class NavigationPathQueryResult3D: RefCounted {
    ...
    /// The resulting path array from the navigation query. All path array positions are in global coordinates. Without customized query parameters this is the same path as returned by ``NavigationServer3D/mapGetPath(map:origin:destination:optimize:navigationLayers:)``.
    final public var path: PackedVector3Array {
        get {
            return get_path ()
        }
    ...
    fileprivate final func set_path (_ path: PackedVector3Array) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationPathQueryResult3D.method_set_path, UnsafeMutableRawPointer (mutating: handle), nil, &path.content)
        ...
        withUnsafePointer (to: &path.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationPathQueryResult3D.method_set_path, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_path_types (_ pathTypes: PackedInt32Array) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationPathQueryResult3D.method_set_path_types, UnsafeMutableRawPointer (mutating: handle), nil, &pathTypes.content)
        ...
        withUnsafePointer (to: &pathTypes.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationPathQueryResult3D.method_set_path_types, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_path_rids (_ pathRids: VariantCollection<RID>) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationPathQueryResult3D.method_set_path_rids, UnsafeMutableRawPointer (mutating: handle), nil, &pathRids.array.content)
        ...
        withUnsafePointer (to: &pathRids.array.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationPathQueryResult3D.method_set_path_rids, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_path_owner_ids (_ pathOwnerIds: PackedInt64Array) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationPathQueryResult3D.method_set_path_owner_ids, UnsafeMutableRawPointer (mutating: handle), nil, &pathOwnerIds.content)
        ...
        withUnsafePointer (to: &pathOwnerIds.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationPathQueryResult3D.method_set_path_owner_ids, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
