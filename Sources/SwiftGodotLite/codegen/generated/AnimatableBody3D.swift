...
open class AnimatableBody3D: StaticBody3D {
    ...
    fileprivate final func set_sync_to_physics (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatableBody3D.method_set_sync_to_physics, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatableBody3D.method_set_sync_to_physics, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
