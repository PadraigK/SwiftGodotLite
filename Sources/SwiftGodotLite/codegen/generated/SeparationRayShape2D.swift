...
open class SeparationRayShape2D: Shape2D {
    override open class var godotClassName: StringName { "SeparationRayShape2D" }
    ...
    fileprivate final func set_length (_ length: Double) {
        ...
        gi.object_method_bind_ptrcall_v (SeparationRayShape2D.method_set_length, UnsafeMutableRawPointer (mutating: handle), nil, &copy_length)
        ...
        withUnsafePointer (to: &copy_length) { p0 in
            ...
            gi.object_method_bind_ptrcall (SeparationRayShape2D.method_set_length, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_length ()-> Double {
        ...
        gi.object_method_bind_ptrcall (SeparationRayShape2D.method_get_length, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_slide_on_slope (_ active: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (SeparationRayShape2D.method_set_slide_on_slope, UnsafeMutableRawPointer (mutating: handle), nil, &copy_active)
        ...
        withUnsafePointer (to: &copy_active) { p0 in
            ...
            gi.object_method_bind_ptrcall (SeparationRayShape2D.method_set_slide_on_slope, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_slide_on_slope ()-> Bool {
        ...
        gi.object_method_bind_ptrcall (SeparationRayShape2D.method_get_slide_on_slope, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
