...
open class RemoteTransform3D: Node3D {
    ...
    fileprivate final func set_remote_node (_ path: NodePath) {
        ...
        withUnsafePointer (to: &path.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (RemoteTransform3D.method_set_remote_node, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_use_global_coordinates (_ useGlobalCoordinates: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (RemoteTransform3D.method_set_use_global_coordinates, UnsafeMutableRawPointer (mutating: handle), nil, &copy_use_global_coordinates)
        ...
        withUnsafePointer (to: &copy_use_global_coordinates) { p0 in
            ...
            gi.object_method_bind_ptrcall (RemoteTransform3D.method_set_use_global_coordinates, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_update_position (_ updateRemotePosition: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (RemoteTransform3D.method_set_update_position, UnsafeMutableRawPointer (mutating: handle), nil, &copy_update_remote_position)
        ...
        withUnsafePointer (to: &copy_update_remote_position) { p0 in
            ...
            gi.object_method_bind_ptrcall (RemoteTransform3D.method_set_update_position, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_update_rotation (_ updateRemoteRotation: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (RemoteTransform3D.method_set_update_rotation, UnsafeMutableRawPointer (mutating: handle), nil, &copy_update_remote_rotation)
        ...
        withUnsafePointer (to: &copy_update_remote_rotation) { p0 in
            ...
            gi.object_method_bind_ptrcall (RemoteTransform3D.method_set_update_rotation, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_update_scale (_ updateRemoteScale: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (RemoteTransform3D.method_set_update_scale, UnsafeMutableRawPointer (mutating: handle), nil, &copy_update_remote_scale)
        ...
        withUnsafePointer (to: &copy_update_remote_scale) { p0 in
            ...
            gi.object_method_bind_ptrcall (RemoteTransform3D.method_set_update_scale, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
