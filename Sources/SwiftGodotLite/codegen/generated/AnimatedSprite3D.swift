...
open class AnimatedSprite3D: SpriteBase3D {
    ...
    fileprivate final func set_sprite_frames (_ spriteFrames: SpriteFrames?) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_set_sprite_frames, UnsafeMutableRawPointer (mutating: handle), nil, &copy_sprite_frames_handle)
        ...
        _args.append (spriteFrames == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_sprite_frames, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_animation (_ name: StringName) {
        ...
        withUnsafePointer (to: &name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_animation, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_autoplay (_ name: String) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_set_autoplay, UnsafeMutableRawPointer (mutating: handle), nil, &gstr_name.content)
        ...
        withUnsafePointer (to: &gstr_name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_autoplay, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func play (name: StringName = StringName (""), customSpeed: Double = 1.0, fromEnd: Bool = false) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_play, UnsafeMutableRawPointer (mutating: handle), nil, &name.content, &copy_custom_speed, &copy_from_end)
        ...
        withUnsafePointer (to: &name.content) { p0 in
            ...
            withUnsafePointer (to: &copy_custom_speed) { p1 in
                ...
                withUnsafePointer (to: &copy_from_end) { p2 in
                    ...
                    gi.object_method_bind_ptrcall (AnimatedSprite3D.method_play, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
                }
            }
        }
    ...
    public final func playBackwards (name: StringName = StringName ("")) {
        ...
        withUnsafePointer (to: &name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_play_backwards, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_frame (_ frame: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_set_frame, UnsafeMutableRawPointer (mutating: handle), nil, &copy_frame)
        ...
        withUnsafePointer (to: &copy_frame) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_frame, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_frame_progress (_ progress: Double) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_set_frame_progress, UnsafeMutableRawPointer (mutating: handle), nil, &copy_progress)
        ...
        withUnsafePointer (to: &copy_progress) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_frame_progress, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func setFrameAndProgress (frame: Int32, progress: Double) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_set_frame_and_progress, UnsafeMutableRawPointer (mutating: handle), nil, &copy_frame, &copy_progress)
        ...
        withUnsafePointer (to: &copy_frame) { p0 in
            ...
            withUnsafePointer (to: &copy_progress) { p1 in
                ...
                gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_frame_and_progress, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    fileprivate final func set_speed_scale (_ speedScale: Double) {
        ...
        gi.object_method_bind_ptrcall_v (AnimatedSprite3D.method_set_speed_scale, UnsafeMutableRawPointer (mutating: handle), nil, &copy_speed_scale)
        ...
        withUnsafePointer (to: &copy_speed_scale) { p0 in
            ...
            gi.object_method_bind_ptrcall (AnimatedSprite3D.method_set_speed_scale, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
