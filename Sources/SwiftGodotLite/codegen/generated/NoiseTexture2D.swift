...
open class NoiseTexture2D: Texture2D {
    ...
    fileprivate final func set_width (_ width: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_width, UnsafeMutableRawPointer (mutating: handle), nil, &copy_width)
        ...
        withUnsafePointer (to: &copy_width) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_width, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_height (_ height: Int32) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_height, UnsafeMutableRawPointer (mutating: handle), nil, &copy_height)
        ...
        withUnsafePointer (to: &copy_height) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_height, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_invert (_ invert: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_invert, UnsafeMutableRawPointer (mutating: handle), nil, &copy_invert)
        ...
        withUnsafePointer (to: &copy_invert) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_invert, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_in_3d_space (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_in_3d_space, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_in_3d_space, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_generate_mipmaps (_ invert: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_generate_mipmaps, UnsafeMutableRawPointer (mutating: handle), nil, &copy_invert)
        ...
        withUnsafePointer (to: &copy_invert) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_generate_mipmaps, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_seamless (_ seamless: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_seamless, UnsafeMutableRawPointer (mutating: handle), nil, &copy_seamless)
        ...
        withUnsafePointer (to: &copy_seamless) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_seamless, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_seamless_blend_skirt (_ seamlessBlendSkirt: Double) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_seamless_blend_skirt, UnsafeMutableRawPointer (mutating: handle), nil, &copy_seamless_blend_skirt)
        ...
        withUnsafePointer (to: &copy_seamless_blend_skirt) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_seamless_blend_skirt, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_as_normal_map (_ asNormalMap: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_as_normal_map, UnsafeMutableRawPointer (mutating: handle), nil, &copy_as_normal_map)
        
        #else
        
        var copy_as_normal_map = asNormalMap
        var _args: [UnsafeRawPointer?] = []
        withUnsafePointer (to: &copy_as_normal_map) { p0 in
            _args.append (p0)
        
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_as_normal_map, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_bump_strength (_ bumpStrength: Double) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_bump_strength, UnsafeMutableRawPointer (mutating: handle), nil, &copy_bump_strength)
        
        #else
        
        var copy_bump_strength = bumpStrength
        var _args: [UnsafeRawPointer?] = []
        withUnsafePointer (to: &copy_bump_strength) { p0 in
            _args.append (p0)
        
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_bump_strength, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_normalize (_ normalize: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_normalize, UnsafeMutableRawPointer (mutating: handle), nil, &copy_normalize)
        ...
        withUnsafePointer (to: &copy_normalize) { p0 in
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_normalize, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_color_ramp (_ gradient: Gradient?) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_color_ramp, UnsafeMutableRawPointer (mutating: handle), nil, &copy_gradient_handle)
        ...
        _args.append (gradient == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_color_ramp, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_noise (_ noise: Noise?) {
        ...
        gi.object_method_bind_ptrcall_v (NoiseTexture2D.method_set_noise, UnsafeMutableRawPointer (mutating: handle), nil, &copy_noise_handle)
        ...
        _args.append (noise == nil ? nil : p0)
            ...
            gi.object_method_bind_ptrcall (NoiseTexture2D.method_set_noise, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
