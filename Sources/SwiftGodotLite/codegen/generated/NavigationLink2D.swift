...
open class NavigationLink2D: Node2D {
    override open class var godotClassName: StringName { "NavigationLink2D" }
    
    /* Properties */
    
    /// Whether this link is currently active. If `false`, ``NavigationServer2D/mapGetPath(map:origin:destination:optimize:navigationLayers:)`` will ignore this link.
    ...
    /// A bitfield determining all navigation layers the link belongs to. These navigation layers will be checked when requesting a path with ``NavigationServer2D/mapGetPath(map:origin:destination:optimize:navigationLayers:)``.
    ...
    /// 
    /// The distance the link will search is controlled by ``NavigationServer2D/mapSetLinkConnectionRadius(map:radius:)``.
    /// 
    ...
    /// The distance the link will search is controlled by ``NavigationServer2D/mapSetLinkConnectionRadius(map:radius:)``.
    /// 
    final public var endPosition: Vector2 {
        get {
    ...
    fileprivate static var method_set_enabled: GDExtensionMethodBindPtr = {
        ...
        return withUnsafePointer (to: &NavigationLink2D.godotClassName.content) { classPtr in
    ...
    fileprivate final func set_enabled (_ enabled: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_enabled, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enabled)
        ...
        withUnsafePointer (to: &copy_enabled) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_enabled, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func is_enabled ()-> Bool {
        ...
        gi.object_method_bind_ptrcall (NavigationLink2D.method_is_enabled, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_bidirectional (_ bidirectional: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_bidirectional, UnsafeMutableRawPointer (mutating: handle), nil, &copy_bidirectional)
        ...
        withUnsafePointer (to: &copy_bidirectional) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_bidirectional, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func is_bidirectional ()-> Bool {
        var _result: Bool = false
        gi.object_method_bind_ptrcall (NavigationLink2D.method_is_bidirectional, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_navigation_layers (_ navigationLayers: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_navigation_layers, UnsafeMutableRawPointer (mutating: handle), nil, &copy_navigation_layers)
        ...
        withUnsafePointer (to: &copy_navigation_layers) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_navigation_layers, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_navigation_layers ()-> UInt32 {
        ...
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_navigation_layers, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    public final func setNavigationLayerValue (layerNumber: Int32, value: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_navigation_layer_value, UnsafeMutableRawPointer (mutating: handle), nil, &copy_layer_number, &copy_value)
        ...
        withUnsafePointer (to: &copy_layer_number) { p0 in
            ...
            withUnsafePointer (to: &copy_value) { p1 in
                ...
                gi.object_method_bind_ptrcall (NavigationLink2D.method_set_navigation_layer_value, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    public final func getNavigationLayerValue (layerNumber: Int32)-> Bool {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_get_navigation_layer_value, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_layer_number)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_layer_number) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_get_navigation_layer_value, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    fileprivate final func set_start_position (_ position: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_start_position, UnsafeMutableRawPointer (mutating: handle), nil, &copy_position)
        ...
        withUnsafePointer (to: &copy_position) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_start_position, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_start_position ()-> Vector2 {
        ...
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_start_position, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_end_position (_ position: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_end_position, UnsafeMutableRawPointer (mutating: handle), nil, &copy_position)
        ...
        withUnsafePointer (to: &copy_position) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_end_position, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    @inline(__always)
    fileprivate final func get_end_position ()-> Vector2 {
        var _result: Vector2 = Vector2 ()
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_end_position, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    public final func setGlobalStartPosition (_ position: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_global_start_position, UnsafeMutableRawPointer (mutating: handle), nil, &copy_position)
        ...
        withUnsafePointer (to: &copy_position) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_global_start_position, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func getGlobalStartPosition ()-> Vector2 {
        var _result: Vector2 = Vector2 ()
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_global_start_position, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    public final func setGlobalEndPosition (_ position: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_global_end_position, UnsafeMutableRawPointer (mutating: handle), nil, &copy_position)
        ...
        withUnsafePointer (to: &copy_position) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_global_end_position, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func getGlobalEndPosition ()-> Vector2 {
        var _result: Vector2 = Vector2 ()
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_global_end_position, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_enter_cost (_ enterCost: Double) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_enter_cost, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enter_cost)
        ...
        withUnsafePointer (to: &copy_enter_cost) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_enter_cost, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_enter_cost ()-> Double {
        ...
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_enter_cost, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
    ...
    fileprivate final func set_travel_cost (_ travelCost: Double) {
        ...
        gi.object_method_bind_ptrcall_v (NavigationLink2D.method_set_travel_cost, UnsafeMutableRawPointer (mutating: handle), nil, &copy_travel_cost)
        ...
        withUnsafePointer (to: &copy_travel_cost) { p0 in
            ...
            gi.object_method_bind_ptrcall (NavigationLink2D.method_set_travel_cost, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func get_travel_cost ()-> Double {
        var _result: Double = 0.0
        gi.object_method_bind_ptrcall (NavigationLink2D.method_get_travel_cost, UnsafeMutableRawPointer (mutating: handle), nil, &_result)
        return _result
    }
