...
open class MissingNode: Node {
    ...
    fileprivate final func set_original_class (_ name: String) {
        ...
        gi.object_method_bind_ptrcall_v (MissingNode.method_set_original_class, UnsafeMutableRawPointer (mutating: handle), nil, &gstr_name.content)
        ...
        withUnsafePointer (to: &gstr_name.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (MissingNode.method_set_original_class, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_recording_properties (_ enable: Bool) {
        ...
        gi.object_method_bind_ptrcall_v (MissingNode.method_set_recording_properties, UnsafeMutableRawPointer (mutating: handle), nil, &copy_enable)
        ...
        withUnsafePointer (to: &copy_enable) { p0 in
            ...
            gi.object_method_bind_ptrcall (MissingNode.method_set_recording_properties, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
