...
open class Texture2DRD: Texture2D {
    ...
    fileprivate final func set_texture_rd_rid (_ textureRdRid: RID) {
        ...
        gi.object_method_bind_ptrcall_v (Texture2DRD.method_set_texture_rd_rid, UnsafeMutableRawPointer (mutating: handle), nil, &textureRdRid.content)
        ...
        withUnsafePointer (to: &textureRdRid.content) { p0 in
            ...
            gi.object_method_bind_ptrcall (Texture2DRD.method_set_texture_rd_rid, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
