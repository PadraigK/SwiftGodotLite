...
open class AStar2D: RefCounted {
    ...
    public final func addPoint (id: Int, position: Vector2, weightScale: Double = 1.0) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_add_point, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id, &copy_position, &copy_weight_scale)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            withUnsafePointer (to: &copy_position) { p1 in
                ...
                withUnsafePointer (to: &copy_weight_scale) { p2 in
                    ...
                    gi.object_method_bind_ptrcall (AStar2D.method_add_point, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
                }
            }
        }
    ...
    public final func getPointPosition (id: Int)-> Vector2 {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_point_position, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_id) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_get_point_position, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    public final func setPointPosition (id: Int, position: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_set_point_position, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id, &copy_position)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            withUnsafePointer (to: &copy_position) { p1 in
                ...
                gi.object_method_bind_ptrcall (AStar2D.method_set_point_position, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    public final func getPointWeightScale (id: Int)-> Double {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_point_weight_scale, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_id) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_get_point_weight_scale, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    public final func setPointWeightScale (id: Int, weightScale: Double) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_set_point_weight_scale, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id, &copy_weight_scale)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            withUnsafePointer (to: &copy_weight_scale) { p1 in
                ...
                gi.object_method_bind_ptrcall (AStar2D.method_set_point_weight_scale, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    public final func removePoint (id: Int) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_remove_point, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_remove_point, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func hasPoint (id: Int)-> Bool {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_has_point, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_id) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_has_point, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    public final func getPointConnections (id: Int)-> PackedInt64Array {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_point_connections, UnsafeMutableRawPointer (mutating: handle), &_result.content, &copy_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_id) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_get_point_connections, UnsafeMutableRawPointer (mutating: handle), &_args, &_result.content)
            return _result
        }
    ...
    public final func setPointDisabled (id: Int, disabled: Bool = true) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_set_point_disabled, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id, &copy_disabled)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            withUnsafePointer (to: &copy_disabled) { p1 in
                ...
                gi.object_method_bind_ptrcall (AStar2D.method_set_point_disabled, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
            }
        }
    ...
    public final func isPointDisabled (id: Int)-> Bool {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_is_point_disabled, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_id) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_is_point_disabled, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    public final func connectPoints (id: Int, toId: Int, bidirectional: Bool = true) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_connect_points, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id, &copy_to_id, &copy_bidirectional)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            withUnsafePointer (to: &copy_to_id) { p1 in
                ...
                withUnsafePointer (to: &copy_bidirectional) { p2 in
                    ...
                    gi.object_method_bind_ptrcall (AStar2D.method_connect_points, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
                }
            }
        }
    ...
    public final func disconnectPoints (id: Int, toId: Int, bidirectional: Bool = true) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_disconnect_points, UnsafeMutableRawPointer (mutating: handle), nil, &copy_id, &copy_to_id, &copy_bidirectional)
        ...
        withUnsafePointer (to: &copy_id) { p0 in
            ...
            withUnsafePointer (to: &copy_to_id) { p1 in
                ...
                withUnsafePointer (to: &copy_bidirectional) { p2 in
                    ...
                    gi.object_method_bind_ptrcall (AStar2D.method_disconnect_points, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
                }
            }
        }
    ...
    public final func arePointsConnected (id: Int, toId: Int, bidirectional: Bool = true)-> Bool {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_are_points_connected, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_id, &copy_to_id, &copy_bidirectional)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_id) { p0 in
            ...
            return withUnsafePointer (to: &copy_to_id) { p1 in
                ...
                return withUnsafePointer (to: &copy_bidirectional) { p2 in
                    ...
                    gi.object_method_bind_ptrcall (AStar2D.method_are_points_connected, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
                    return _result
                }
            }
        }
    ...
    public final func reserveSpace (numNodes: Int) {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_reserve_space, UnsafeMutableRawPointer (mutating: handle), nil, &copy_num_nodes)
        ...
        withUnsafePointer (to: &copy_num_nodes) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_reserve_space, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func getClosestPoint (toPosition: Vector2, includeDisabled: Bool = false)-> Int {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_closest_point, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_to_position, &copy_include_disabled)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_to_position) { p0 in
            ...
            return withUnsafePointer (to: &copy_include_disabled) { p1 in
                ...
                gi.object_method_bind_ptrcall (AStar2D.method_get_closest_point, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
                return _result
            }
        }
    ...
    public final func getClosestPositionInSegment (toPosition: Vector2)-> Vector2 {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_closest_position_in_segment, UnsafeMutableRawPointer (mutating: handle), &_result, &copy_to_position)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_to_position) { p0 in
            ...
            gi.object_method_bind_ptrcall (AStar2D.method_get_closest_position_in_segment, UnsafeMutableRawPointer (mutating: handle), &_args, &_result)
            return _result
        }
    ...
    fileprivate static var method_get_point_path: GDExtensionMethodBindPtr = {
        ...
        return withUnsafePointer (to: &AStar2D.godotClassName.content) { classPtr in
            withUnsafePointer (to: &methodName.content) { mnamePtr in
                gi.classdb_get_method_bind (classPtr, mnamePtr, 281625055)!
            }
    ...
    public final func getPointPath (fromId: Int, toId: Int)-> PackedVector2Array {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_point_path, UnsafeMutableRawPointer (mutating: handle), &_result.content, &copy_from_id, &copy_to_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_from_id) { p0 in
            ...
            return withUnsafePointer (to: &copy_to_id) { p1 in
                ...
                gi.object_method_bind_ptrcall (AStar2D.method_get_point_path, UnsafeMutableRawPointer (mutating: handle), &_args, &_result.content)
                return _result
            }
        }
    ...
    public final func getIdPath (fromId: Int, toId: Int)-> PackedInt64Array {
        ...
        gi.object_method_bind_ptrcall_v (AStar2D.method_get_id_path, UnsafeMutableRawPointer (mutating: handle), &_result.content, &copy_from_id, &copy_to_id)
        return _result
        #else
        ...
        return withUnsafePointer (to: &copy_from_id) { p0 in
            ...
            return withUnsafePointer (to: &copy_to_id) { p1 in
                ...
                gi.object_method_bind_ptrcall (AStar2D.method_get_id_path, UnsafeMutableRawPointer (mutating: handle), &_args, &_result.content)
                return _result
            }
        }
