...
open class VisualShaderNodeVec2Constant: VisualShaderNodeConstant {
    ...
    fileprivate final func set_constant (_ constant: Vector2) {
        ...
        gi.object_method_bind_ptrcall_v (VisualShaderNodeVec2Constant.method_set_constant, UnsafeMutableRawPointer (mutating: handle), nil, &copy_constant)
        ...
        withUnsafePointer (to: &copy_constant) { p0 in
            ...
            gi.object_method_bind_ptrcall (VisualShaderNodeVec2Constant.method_set_constant, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
