...
open class RDTextureFormat: RefCounted {
    ...
    fileprivate final func set_format (_ pMember: RenderingDevice.DataFormat) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_format, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_format, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_width (_ pMember: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_width, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_width, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_height (_ pMember: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_height, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_height, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_depth (_ pMember: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_depth, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_depth, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_array_layers (_ pMember: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_array_layers, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_array_layers, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_mipmaps (_ pMember: UInt32) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_mipmaps, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_mipmaps, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_texture_type (_ pMember: RenderingDevice.TextureType) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_texture_type, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_texture_type, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_samples (_ pMember: RenderingDevice.TextureSamples) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_samples, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_samples, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    fileprivate final func set_usage_bits (_ pMember: RenderingDevice.TextureUsageBits) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_set_usage_bits, UnsafeMutableRawPointer (mutating: handle), nil, &copy_p_member)
        ...
        withUnsafePointer (to: &copy_p_member) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_set_usage_bits, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func addShareableFormat (_ format: RenderingDevice.DataFormat) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_add_shareable_format, UnsafeMutableRawPointer (mutating: handle), nil, &copy_format)
        ...
        withUnsafePointer (to: &copy_format) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_add_shareable_format, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
    ...
    public final func removeShareableFormat (_ format: RenderingDevice.DataFormat) {
        ...
        gi.object_method_bind_ptrcall_v (RDTextureFormat.method_remove_shareable_format, UnsafeMutableRawPointer (mutating: handle), nil, &copy_format)
        ...
        withUnsafePointer (to: &copy_format) { p0 in
            ...
            gi.object_method_bind_ptrcall (RDTextureFormat.method_remove_shareable_format, UnsafeMutableRawPointer (mutating: handle), &_args, nil)
        }
